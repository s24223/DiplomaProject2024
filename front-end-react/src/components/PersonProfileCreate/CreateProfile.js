    ...
    return(
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" onChange={e => setSurname(e.target.value)} required /><br />
                <label>BirthDate:</label><br />
                <input type="date" onChange={e => handleBirthDate(e.target.value)} required /><br />
                <label>Email:</label><br />
                <input type="email" onChange={e => setContactEmail(e.target.value)} required /><br />
                <label>Phone Number (format: 123456789):</label><br />
                <input type="tel" pattern="[0-9]{9}" onChange={e => setContactPhoneNum(e.target.value)} required /><br />
