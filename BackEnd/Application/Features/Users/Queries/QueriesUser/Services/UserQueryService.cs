...
namespace Application.Features.Users.Queries.QueriesUser.Services
{
    ...
    {
        //Values
        private readonly IUserQueryRepository _queriesRepository;
        ...
        public UserQueryService
            (
            IUserQueryRepository queriesRepository,
        ...
        //================================================================================================
        //Public Methods
        public async Task<ResponseItem<GetUserQueryResp>> GetUserDataAsync
            (
            ...
            )
        {
            ...
            return new ResponseItem<GetUserQueryResp>
            {
                Item = new GetUserQueryResp(
                    domainUser.User,
